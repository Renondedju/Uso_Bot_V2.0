...
class Beatmap():
	...
	def import_beatmap(self):
		...
		self.PP_98 = peppers['nomod']['08'][0]
		self.PP_98_HR = peppers['HR']['08'][0]
		self.PP_98_HD = peppers['HD']['08'][0]
		self.PP_98_DT = peppers['DT']['08'][0]
		self.PP_98_DTHD = peppers['HDDT']['08'][0]
		self.PP_98_DTHR = peppers['HRDT']['08'][0]
		self.PP_98_HRHD = peppers['HDHR']['08'][0]
		self.PP_98_DTHRHD = peppers['HDHRDT']['08'][0]
